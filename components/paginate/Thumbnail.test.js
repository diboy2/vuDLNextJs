...
import * as PaginatorContext from "../../context/PaginatorContext";
...
describe("Thumbnail", () => {
    ...
    beforeEach(() => {
        ...
        jest.spyOn(PaginatorContext.default, "usePaginatorContext").mockReturnValue(paginatorValues);
        console.log("PaginatorContext", PaginatorContext);
    });
